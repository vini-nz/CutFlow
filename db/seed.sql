...
INSERT INTO chapas (projeto_id, largura_mm, altura_mm, espessura_mm, material, quantidade_disponivel, kerf_mm, margem_borda_mm)
SELECT id, 1840, 2740, 15, 'MDF', 10, 4, 6 FROM projetos WHERE nome = 'Armário Cozinha João';
